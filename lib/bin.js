...
Commander.on('--help', function () {
	...
	console.log('  Demo1: file-stats -d \'./\' -f \'/(.html\b)$/i\' -x \'/(banner.html)/i\' -e \'/(/view/)/i\'\n');
	console.log('  Demo2: file-stats -c \'./myConfig.js\'\n');
});

// options
Commander
// version
.option('-v, -V, --version', 'output version number', function () {
	stat = false;
	console.log('\nversion: ' + pkg.version + '\n');
	console.log('Home: https://github.com/xudeming208/file-stats\n');
})
